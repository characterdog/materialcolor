    ...
    public static class MyMaterialAboutFragment extends MaterialAboutFragment {
        ...
        protected MaterialAboutList getMaterialAboutList(final Context activityContext) {
            ...
            firstCard.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_person_orange_24dp)
            ...
            firstCard.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_language_orange_24dp)
                    .setOnClickAction(new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
            ...
            firstCard.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_star_orange_24dp)
                    .setOnClickAction(new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
            ...
            firstCard.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_share_orange_24dp)
                    .setOnClickAction(new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
            ...
            legalCard.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_account_balance_orange_24dp)
                    .setOnClickAction(new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
                            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/characterdog/materialcolor/LICENSE"));
                            startActivity(intent);
                        }
                    })
                    .build());
            legalCard.addItem(new MaterialAboutActionItem.Builder()
                    ...
                    .icon(R.drawable.ic_security_orange_24dp)
                    .setOnClickAction(new MaterialAboutItemOnClickAction() {
                        @Override
                        public void onClick() {
            ...
            Drawable codeDrawable = activityContext.getResources().getDrawable(R.drawable.ic_code_orange_24dp);
